...
public class Core {
    ...
    private static String getVersion() { return "3.0.0-beta"; }
    ...
    private static String getVersionStatus() { return "-beta"; }
 ...
 *
 * <p>In case of complex (two-channel) data, performed a complex matrix
 * multiplication.
 * The function can be replaced with a matrix expression. For example, the above
 * call can be replaced with: <code></p>
 *
 * <p>// C++ code:</p>
 *
 ...
 * <p></code></p>
 *
 * @param src1 first multiplied input matrix that could be real(<code>CV_32FC1</code>,
 * <code>CV_64FC1</code>) or complex(<code>CV_32FC2</code>, <code>CV_64FC2</code>).
