 ...
 *   <li> SOLVEPNP_UPNP Method is based on the paper of A.Penate-Sanchez,
 * J.Andrade-Cetto, F.Moreno-Noguer. "Exhaustive Linearization for Robust Camera
 * Pose and Focal Length Estimation". In this case the function also estimates
 * the parameters <em>f_x</em> and <em>f_y</em> assuming that both have the same
 * value. Then the <code>cameraMatrix</code> is updated with the estimated focal
 * length.
 * </ul>
 *
