 ...
 *
 * <p>Also, the special values <code>THRESH_OTSU</code> or <code>THRESH_TRIANGLE</code>
 * may be combined with one of the above values. In these cases, the function
 * determines the optimal threshold value using the Otsu's or Triangle algorithm
 * and uses it instead of the specified <code>thresh</code>.
 * The function returns the computed threshold value.
 * Currently, the Otsu's and Triangle methods are implemented only for 8-bit
 * images.</p>
 *
